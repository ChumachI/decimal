...
START_TEST(my_mul_18) {
  my_decimal value_1 = {{5, 0, 0, 0}};
  my_decimal value_2 = {{7, 0, 0, 0}};
  my_decimal result = {{0, 0, 0, 0}};
  my_decimal check = {{35, 0, 0, 0}};
  int return_value = my_mul(value_1, value_2, &result);
...
START_TEST(my_mul_19) {
  my_decimal value_1 = {{0xFFFFFFFF, 0, 0, 0}};
  my_decimal value_2 = {{0xFFFFFFFF, 0, 0, 0}};
  my_decimal result = {{0, 0, 0, 0}};
  my_decimal check = {{1, 0xFFFFFFFE, 0, 0}};
  int return_value = my_mul(value_1, value_2, &result);
  ck_assert_int_eq(my_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
}
...
START_TEST(my_mul_21) {
  my_decimal value_1 = {{123456u, 123u, 0, 0}};
  my_decimal value_2 = {{654321u, 654u, 0, 0}};
  _set_sign(&value_2, 1);
  _set_scale(&value_1, 2);
  _set_scale(&value_2, 3);
  my_decimal result = {{0, 0, 0, 0}};
  my_decimal check = {{0xcedabe40, 0x99c0c5d, 0x13a3a, 0x80050000}};
  int return_value = my_mul(value_1, value_2, &result);
  ck_assert_int_eq(my_is_equal(result, check), 1);
  ck_assert_int_eq(return_value, 0);
}
...
Suite *suite_mul(void) {
  ...
  tcase_add_test(tc, my_mul_1);
  tcase_add_test(tc, my_mul_2);
  tcase_add_test(tc, my_mul_3);
  tcase_add_test(tc, my_mul_4);
  tcase_add_test(tc, my_mul_5);
  tcase_add_test(tc, my_mul_6);
  tcase_add_test(tc, my_mul_7);
  tcase_add_test(tc, my_mul_8);
  tcase_add_test(tc, my_mul_9);
  tcase_add_test(tc, my_mul_10);
  tcase_add_test(tc, my_mul_11);
  tcase_add_test(tc, my_mul_12);
  tcase_add_test(tc, my_mul_13);
  tcase_add_test(tc, my_mul_14);
  tcase_add_test(tc, my_mul_15);
  tcase_add_test(tc, my_mul_16);
  tcase_add_test(tc, my_mul_17);
  tcase_add_test(tc, my_mul_18);
  tcase_add_test(tc, my_mul_19);
  tcase_add_test(tc, my_mul_20);
  tcase_add_test(tc, my_mul_21);
  tcase_add_test(tc, my_mul_22);
  tcase_add_test(tc, my_mul_23);
  tcase_add_test(tc, my_mul_24);
