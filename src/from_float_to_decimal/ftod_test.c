...
START_TEST(test_ftod_1) {
  my_decimal dst = {0};
  int status = my_from_float_to_decimal(8e96, &dst);
...
START_TEST(test_ftod_2) {
  my_decimal dst = {0};
  int status = my_from_float_to_decimal(INFINITY, &dst);
  ck_assert_int_eq(status, 1);
}
END_TEST
...
START_TEST(test_ftod_3) {
  my_decimal dst = {0};
  int status = my_from_float_to_decimal(9876543.1234567, &dst);
...
START_TEST(test_ftod_4) {
  my_decimal dst = {0};
  int status = my_from_float_to_decimal(1e-29, &dst);
  ck_assert_int_eq(status, 1);
...
START_TEST(test_ftod_5) {
  my_decimal dst = {0};
  int status = my_from_float_to_decimal(-1234.5, &dst);
...
START_TEST(test_ftod_6) {
  my_decimal dst = {0};
  int status = my_from_float_to_decimal(1234.554352, &dst);
  ck_assert_int_eq(status, 0);
...
START_TEST(test_ftod_7) {
  my_decimal dst = {0};
  int status = my_from_float_to_decimal(-1.5543524553, &dst);
  ck_assert_int_eq(status, 0);
  ck_assert_int_eq(_find_bit(dst, 127), 1);
...
START_TEST(test_ftod_8) {
  int status = my_from_float_to_decimal(-1.5543524553, NULL);
  ck_assert_int_eq(status, 1);
}
END_TEST
...
START_TEST(test_ftod_9) {
  my_decimal dst = {0};
  int status = my_from_float_to_decimal(-1.5543529553, &dst);
  ck_assert_int_eq(status, 0);
  ck_assert_int_eq(_find_bit(dst, 127), 1);
