...
START_TEST(my_sub_23) {
  ...
  _set_sign(&value_2, 1);
  my_decimal result;
  my_decimal check = {{156, 0, 0, 0}};
  _set_scale(&check, 2);
  int return_value = my_sub(value_1, value_2, &result);
...
START_TEST(my_sub_27) {
  my_decimal value_1 = {{64071, 0, 0, 0}};
  _set_scale(&value_1, 4);
  my_decimal value_2 = {{5919, 0, 0, 0}};
  _set_scale(&value_2, 1);
  my_decimal result;
  my_decimal check = {{5854929, 0, 0, 0}};
  _set_scale(&check, 4);
  _set_sign(&check, 1);
  int return_value = my_sub(value_1, value_2, &result);
  ck_assert_int_eq(my_is_equal(result, check), 1);
...
START_TEST(my_sub_30) {
  my_decimal value_1 = {{0xfffffffe, 0xffffffff, 0xffffffff, 0}};
  my_decimal value_2 = {{6, 0, 0, 0}};
  _set_scale(&value_2, 1);
  my_decimal result;
  int return_value = my_sub(value_1, value_2, &result);
...
START_TEST(my_sub_31) {
  my_decimal value_1 = {{0xfffffffd, 0xffffffff, 0xffffffff, 0}};
...
START_TEST(my_sub_32) {
  ...
  my_decimal value2 = {.bits[0] = 1, .bits[1] = 0, .bits[2] = 0, .bits[3] = 0};
  my_decimal result = {.bits[0] = 0, .bits[1] = 0, .bits[2] = 0, .bits[3] = 0};
  my_sub(value1, value2, &result);
  for (int i = 0; i < 4; i++) {
...
START_TEST(my_sub_35) {
  my_decimal value1 = {.bits[0] = 0, .bits[1] = 1, .bits[2] = 0, .bits[3] = 0};
  my_decimal value2 = {.bits[0] = 1, .bits[1] = 0, .bits[2] = 0, .bits[3] = 0};
  my_decimal result = {.bits[0] = 0, .bits[1] = 0, .bits[2] = 0, .bits[3] = 0};
  my_sub(value1, value2, &result);
...
START_TEST(my_sub_36) {
  ...
  my_decimal result = {.bits[0] = 0, .bits[1] = 0, .bits[2] = 0, .bits[3] = 0};
  int sub_result = my_sub(value1, value2, &result);
...
START_TEST(my_sub_38) {
  my_decimal value1 = {.bits[0] = 2, .bits[1] = 0, .bits[2] = 0, .bits[3] = 0};
  my_decimal value2 = {.bits[0] = 4, .bits[1] = 0, .bits[2] = 0, .bits[3] = 0};
  my_decimal result = {.bits[0] = 0, .bits[1] = 0, .bits[2] = 0, .bits[3] = 0};
  int sub_result = my_sub(value1, value2, &result);
...
START_TEST(my_sub_42) {
  my_decimal value1 = {.bits[0] = 0xfffffffeu,
                        .bits[1] = 0xffffffffu,
                        .bits[2] = 0xffffffffu,
                        .bits[3] = 0};
  my_decimal value2 = {
...
Suite *suite_sub(void) {
  ...
  tcase_add_test(tc, my_sub_1);
  tcase_add_test(tc, my_sub_2);
  tcase_add_test(tc, my_sub_3);
  tcase_add_test(tc, my_sub_4);
  tcase_add_test(tc, my_sub_5);
  tcase_add_test(tc, my_sub_6);
  tcase_add_test(tc, my_sub_7);
  tcase_add_test(tc, my_sub_8);
  tcase_add_test(tc, my_sub_9);
  tcase_add_test(tc, my_sub_10);
  tcase_add_test(tc, my_sub_11);
  tcase_add_test(tc, my_sub_12);
  tcase_add_test(tc, my_sub_13);
  tcase_add_test(tc, my_sub_14);
  tcase_add_test(tc, my_sub_15);
  tcase_add_test(tc, my_sub_16);
  tcase_add_test(tc, my_sub_17);
  tcase_add_test(tc, my_sub_18);
  tcase_add_test(tc, my_sub_19);
  tcase_add_test(tc, my_sub_20);
  tcase_add_test(tc, my_sub_21);
  tcase_add_test(tc, my_sub_22);
  tcase_add_test(tc, my_sub_23);
  tcase_add_test(tc, my_sub_24);
  tcase_add_test(tc, my_sub_25);
  tcase_add_test(tc, my_sub_26);
  tcase_add_test(tc, my_sub_27);
  tcase_add_test(tc, my_sub_28);
  tcase_add_test(tc, my_sub_29);
  tcase_add_test(tc, my_sub_30);
  tcase_add_test(tc, my_sub_31);
  tcase_add_test(tc, my_sub_32);
  tcase_add_test(tc, my_sub_33);
  tcase_add_test(tc, my_sub_34);
  tcase_add_test(tc, my_sub_35);
  tcase_add_test(tc, my_sub_36);
  tcase_add_test(tc, my_sub_37);
  tcase_add_test(tc, my_sub_38);
  tcase_add_test(tc, my_sub_39);
  tcase_add_test(tc, my_sub_40);
  tcase_add_test(tc, my_sub_41);
  tcase_add_test(tc, my_sub_42);
  tcase_add_test(tc, my_sub_43);
