...
START_TEST(truncate_0) {
  ...
  my_decimal res;
  ck_assert_int_eq(0, my_truncate(val, &res));
  float fres = 0;
...
START_TEST(truncate_6) {
  ...
  my_decimal check = {{3, 0, 0, 0}};
  _set_scale(&value_1, 1);
  my_truncate(value_1, &value_1);
  ck_assert_int_eq(my_is_equal(value_1, check), 1);
}
END_TEST

START_TEST(truncate_7) {
  my_decimal value_1 = {{123456, 0, 0, 0}};
...
START_TEST(test_truncate_v1) {
  my_decimal value = {
      .bits[0] = 1234567, .bits[1] = 0, .bits[2] = 0, .bits[3] = (5 << 16)};
  my_decimal result = {0};
...
START_TEST(test_truncate_v2) {
  my_decimal value = {
      .bits[0] = 1294567, .bits[1] = 0, .bits[2] = 0, .bits[3] = (5 << 16)};
  my_decimal result = {0};
  my_truncate(value, &result);
  ck_assert_int_eq(result.bits[0], 12);
  ck_assert_int_eq(result.bits[3], 0);
...
START_TEST(my_trun_4) {
  ...
  float num = 0.0;
  my_from_decimal_to_float(dec1, &num);
  my_decimal result = {0};
...
Suite *suite_truncate(void) {
  ...
  tcase_add_test(tc, test_truncate_v1);
  tcase_add_test(tc, test_truncate_v2);

  tcase_add_test(tc, my_trun_1);
  tcase_add_test(tc, my_trun_2);
  tcase_add_test(tc, my_trun_4);
  tcase_add_test(tc, my_truncate_1);
  tcase_add_test(tc, my_truncate_2);
  tcase_add_test(tc, my_truncate_3);
  tcase_add_test(tc, my_truncate_4);
  tcase_add_test(tc, my_truncate_6);
  tcase_add_test(tc, my_truncate_7);
  tcase_add_test(tc, my_truncate_8);
  tcase_add_test(tc, my_truncateTest1);
  tcase_add_test(tc, my_truncateTest2);
  tcase_add_test(tc, my_truncateTest3);
  tcase_add_test(tc, my_truncateTest4);
  tcase_add_test(tc, my_truncateTest5);
  tcase_add_test(tc, my_truncateTest6);
  tcase_add_test(tc, my_truncateTest7);
  tcase_add_test(tc, my_truncateTest8);
  tcase_add_test(tc, my_truncateTest9);
  tcase_add_test(tc, my_truncateTest10);
  tcase_add_test(tc, my_truncateTest11);
