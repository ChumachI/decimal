...
START_TEST(round_1) {
  my_decimal val = {{3, 3, 3, ~(UINT_MAX / 2)}};
  my_decimal res = {{0}};
  ck_assert_int_eq(0, my_round(val, &res));
}
END_TEST

START_TEST(round_2) {
  my_decimal val = {{3, 3, 3, 0}};
  my_decimal res = {{0}};
  _set_scale(&val, 5);
  ck_assert_int_eq(0, my_round(val, &res));
}
...
START_TEST(round_3) {
  my_decimal val = {{7, 7, 7, ~(UINT_MAX / 2)}};
  my_decimal res = {{0}};
  _set_scale(&val, 5);
  ck_assert_int_eq(0, my_round(val, &res));
}
...
START_TEST(round_4) {
  my_decimal val = {{25, 0, 0, ~(UINT_MAX / 2)}};
  my_decimal res = {{0}};
  _set_scale(&val, 1);
  ck_assert_int_eq(0, my_round(val, &res));
}
...
START_TEST(round_11) {
  my_decimal value_1 = {{7464923, 0, 0, 0}};
  _set_scale(&value_1, 5);
  my_decimal check = {{75, 0, 0, 0}};
  my_decimal result = {0};
  int return_value = my_round(value_1, &result);
...
START_TEST(my_roundTest1) {
  // 8053
  my_decimal src1, origin;
  // src1 = 2;
...
Suite *suite_round(void) {
  ...
  tcase_add_test(tc, my_round_1);
  tcase_add_test(tc, my_round_2);
  tcase_add_test(tc, my_round_3);
  tcase_add_test(tc, my_round_4);
  tcase_add_test(tc, my_round_5);
  tcase_add_test(tc, my_round_6);
  tcase_add_test(tc, my_round_7);
  tcase_add_test(tc, my_round_8);
  tcase_add_test(tc, my_round_9);

  tcase_add_test(tc, my_round_12);
  tcase_add_test(tc, my_round_13);

  tcase_add_test(tc, my_roundTest1);
  tcase_add_test(tc, my_roundTest2);
  tcase_add_test(tc, my_roundTest3);
  tcase_add_test(tc, my_roundTest4);
  tcase_add_test(tc, my_roundTest5);
  tcase_add_test(tc, my_roundTest6);
  tcase_add_test(tc, my_roundTest7);
  tcase_add_test(tc, my_roundTest8);
  tcase_add_test(tc, my_roundTest9);
  tcase_add_test(tc, my_roundTest10);
  tcase_add_test(tc, my_roundTest11);
  tcase_add_test(tc, my_roundTest12);
  tcase_add_test(tc, my_roundTest13);
  tcase_add_test(tc, my_roundTest14);
  tcase_add_test(tc, my_roundTest15);
